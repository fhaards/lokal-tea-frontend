...
import { PrimaryButton as PrimaryButtonBase } from "_components/misc/Buttons.js";
import LogoImage from "_images/app_img/lokaltea_logo_white.svg";
import { ReactComponent as FacebookIcon } from "_images/icon/social/facebook-icon.svg";
import { ReactComponent as TwitterIcon } from "_images/icon/social/twitter-icon.svg";
import { ReactComponent as YoutubeIcon } from "_images/icon/social/youtube-icon.svg";
  ...
  return (
    <Container>
      <Content>
        ...
        <ThreeColColumn>
          <LogoContainer>
            <LogoImg src={LogoImage} width="200px" />
          </LogoContainer>
          <CopywrightNotice>
            &copy; 2022 Lokalteh by Lokal, All right Reserved.
          </CopywrightNotice>
