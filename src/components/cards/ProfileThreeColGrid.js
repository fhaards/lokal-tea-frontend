...
import { ReactComponent as LinkedinIcon } from "images/icon/social/linkedin-icon.svg";
import { ReactComponent as GithubIcon } from "images/icon/misc/github-icon.svg";
