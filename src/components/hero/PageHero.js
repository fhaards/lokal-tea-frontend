...
const Container = styled.div`
  ${tw`relative -mx-8 -mt-8 bg-center bg-cover bg-cover bg-center bg-fixed bg-primary-800 h-64 lg:h-96 rounded-b-6xl`}
`;
...
const HeroImageBackground = styled.div`
  ${tw`z-10 absolute inset-0  h-64 lg:h-96 object-cover w-full flex justify-end items-end rounded-b-6xl`}
`;
...
const Content = tw.div`px-6 lg:px-0 flex flex-1 flex-col justify-center lg:w-6/12 text-center`;
...
const SubHeading = styled.h3`
  ${tw`uppercase text-lg sm:text-sm lg:text-lg xl:text-xl tracking-widest text-primary-800 leading-snug sm:mt-3 mt-3`}
`;
