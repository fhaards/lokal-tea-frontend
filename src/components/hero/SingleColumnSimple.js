...
const Content = tw.div`z-20 px-6 lg:px-0 flex flex-col justify-center items-center md:w-8/12`;

const OpacityOverlay = tw.div`z-10 absolute inset-0 bg-gray-900 opacity-75 w-screen mx-auto`;
...
const Heading = styled.h1`
  ${tw`font-montseralt uppercase text-center text-4xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-100 leading-none -mt-24 sm:mt-0 max-w-2xl`}
  span {
...
const SubHeading = styled.h3`
  ${tw`text-sm sm:text-sm lg:text-lg xl:text-xl tracking-widest text-gray-100 leading-snug sm:mt-3 mt-3`}
  span {
    ${tw`text-red-700`}
  }
`;

const Description = tw.p`font-montser text-gray-100 mt-4 md:text-center text-sm md:text-xl lg:text-xl leading-snug`;
